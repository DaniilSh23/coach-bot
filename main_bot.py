...
from handlers.head_page_handlers import register_head_page_handlers
from handlers.my_trainings import register_my_trainings_handlers
...
def register_all_handlers():
    ...
    register_my_trainings_handlers()
